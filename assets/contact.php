<?php
    if(isset($_POST['submit']))
    {
        ...
        $sub = $_POST['subject']; // Get Subject Value
        $msg = $_POST['message']; // Get Message Value
         
        $to = "kirankumar@idiinfotech.com"; // You can change here your Email
       ...
       $headers .= 'From: ' . $email_id . "\r\n" ; // Give an email id on which you want get a reply. User will get a mail from this email id
        $headers .= 'Cc: kamesh@idiinfotech.com' . "\r\n"; // If you want add cc
      //  $headers .= 'Bcc: boss@idiinfotech.com' . "\r\n"; // If you want add Bcc
